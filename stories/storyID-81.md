...
# S81: As a program officer, I want to make researchers aware of common issues to avoid when writing their DMS Plans  
...
| As a program officer, I want to make researchers aware of common issues to avoid when writing their DMS Plans   | Most DMS Plans come in with the same issues over and over again, causing delays in funding | My overall goal is to reduce the number of DMS Plan revisions required prior to making an award 
